...
<div class="profile left">
    {{ form('profile/informations', 'id': 'profileForm', 'onbeforesubmit': 'return false','enctype': "multipart/form-data") }}
        ...
        <div class="control-group">
            <label class="control-label" for="name">Votre prénom</label>
            <div class="input">
        ...
        <div class="control-group">
            <label class="control-label" for="email">Mot de passe actuel</label>
            <div class="input">
        ...
        <div class="control-group">
            <label class="control-label" for="email">Nouveau mot de passe </label>
            <div class="input">
        ...
        <div class="control-group">
            <label class="control-label" for="email">Répéter le nouveau mot de passe</label>
            <div class="input">
        ...
        <div class="control-group">
            ...
            {# <div class="input"> #}
                {{ file_field("file", "size": "30", "class": "span6 form-control") }}
                <div class="alert" id="email_alert">
                    <strong>Warning!</strong> Please enter your email
                </div>
            {# </div> #}
